...
class Solution {
    ...
    private long solve(long num) {
        ...
        // memo_cnt[pos][x][y]: the number of valid filling schemes where the current
        // digit is at position pos, and the previous two digits are x and y
        memo_cnt = new long[16][10][10];
        // memo_sum[pos][x][y]: the fluctuation value when the current position is pos,
        // and the two left digits are x and y
    ...
    private long[] dfs(
        ...
        // use memoization only when not bounded by an upper limit and without leading
        // zeros
